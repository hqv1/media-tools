...
using Hqv.MediaTools.ThumbnailSheet.Framework;
...
namespace Hqv.MediaTools.ThumbnailSheet.Windows.Tests
{
    [TestClass]
    public class ThumbnailSheetService_IntegrationTest
    {
        ...
        private ThumbnailSheetCreationService _creationService;
